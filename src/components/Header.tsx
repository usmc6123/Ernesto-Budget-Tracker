  ...
  return (
    <header className="relative overflow-hidden border-b border-[var(--line)] px-6 sm:px-8 pt-16 pb-12 bg-[var(--bg)]" id="app-header">
      ...
      <div className="max-w-4xl mx-auto flex justify-between items-center">
        <div>
          <div className="text-[11px] sm:text-xs font-mono tracking-[0.35em] uppercase text-[var(--text2)] mb-3">
            E. Reyes · Personal Ledger
          </div>
          <h1 className="font-serif text-5xl sm:text-6xl font-light tracking-tight text-[var(--bone)]">
